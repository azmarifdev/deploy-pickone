...
import { useCategoryListQuery, useDeleteCategoryMutation } from '@/redux/api/categoryApi';
import { FaEdit, FaTrash, FaPlus, FaSearch, FaFilter, FaTags, FaCalendarAlt, FaEye } from 'react-icons/fa';
                ...
                <div className="bg-white rounded-xl p-6 shadow-sm border border-gray-100 hover:shadow-md transition-shadow">
                    <div className="flex items-center justify-between">
                        <div>
                            ...
                            <p className="text-2xl font-bold text-gray-900 mt-1">{categoryData?.data?.length || 0}</p>
                        </div>
                    ...
                    <div className="flex items-center justify-between">
                        <div>
                            ...
                            <p className="text-sm font-medium text-gray-900 mt-1">
                                {categoryData?.data?.[0]
                                    ? new Date(categoryData.data[0].updatedAt).toLocaleDateString()
                                    : 'No data'}
                            </p>
                        </div>
