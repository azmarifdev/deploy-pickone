...
app.listen(PORT, () => {
    ...
    console.log(`Access the test endpoint at: http://localhost:${PORT}/test-fb-conversion`);
...
app.get('/test-product-view', (req, res) => {
    ...
    try {
        ...
        conversionApi
            .trackProductView('TEST123', 999.99, 'https://example.com/product/test123', { eventId: `pv_test_${Date.now()}` })
            .then(response => {
            res.json({
                success: true,
...
app.get('/test-purchase', (req, res) => {
    ...
    try {
        ...
        conversionApi
            .trackPurchase(products, 2999.97, 'https://example.com/checkout/success', { eventId: `purchase_test_${Date.now()}`, orderId: 'ORDER123' })
            .then(response => {
            res.json({
                success: true,
